...
# this should be implemented with proper message queue handlers, when there is a message for chat it should invoke agent and send the response back
async def to_be_implemented():
    llm= LLMConfig(provider="openai", model_name="gpt-4o")
    system_info = SystemInfo(os="windows", version="11")
    query = "give a breif analysis on tesla stock?"
