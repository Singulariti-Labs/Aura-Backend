...
def prepareMessageForAI(llm_provider: str, attached_files: List[Dict[str, Any]], attached_images: List[Dict[str, Any]], query: str):
    """
    ...
    if "openai" in llm_provider:
        return _format_for_openai(text_files_content, attached_files, attached_images, query)
    elif "anthropic" in llm_provider:
        return _format_for_anthropic(text_files_content, attached_files, attached_images, query)
    elif "gemini" in llm_provider or "google" in llm_provider:
        return _format_for_gemini(text_files_content, attached_files, attached_images, query)
    else:
        return _format_for_openai(text_files_content, attached_files, attached_images, query)

def _format_for_openai(files_text: str, files: List[Dict[str, Any]], images: List[Dict[str, Any]], query: str):
    content = []
...
def _format_for_anthropic(files_text: str, files: List[Dict[str, Any]], images: List[Dict[str, Any]], query: str):
    content = []
...
def _format_for_gemini(files_text: str, files: List[Dict[str, Any]], images: List[Dict[str, Any]], query: str):
    content = []
